...
class PriceOracle {
	...
	constructor(network, addressOfPriceOracle, baseUSD = true) {
	...
	async basePrice() {
		try {
			const fetchLatestDataETHtoUSD = new this.web3.eth.Contract(this.aggregatorV3InterfaceABI, this.addrETHtoUSD)
